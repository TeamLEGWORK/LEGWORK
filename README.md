<p align="center">
    <img width="500", src="https://raw.githubusercontent.com/TeamLEGWORK/LEGWORK/main/docs/_static/images/legwork.png#gh-light-mode-only">
    <img width="500", src="https://raw.githubusercontent.com/TeamLEGWORK/LEGWORK/main/docs/_static/images/legwork_darkmode.png#gh-dark-mode-only">
</p>
...
LEGWORK has a couple of dependencies: `numpy`, `astropy`, `numba`, `scipy`, `h5py`, `schwimmbad`, `matplotlib` and `seaborn` (see [pyproject.toml](pyproject.toml) for the exact version requirements). These will be installed automatically if you follow the installation instructions!
