.. gw-calcs documentation master file, created by
   sphinx-quickstart on Mon Feb  8 22:30:58 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to gw-calcs's documentation!
====================================
**LEGWORK** (**L**\ ISA **Ev**\ olution and **G**\ ravitational **W**\ ave **OR**\ bit **K**\ it) is designed to calculate signal to noise ratios for GWs emitted from inspiraling binary systems that are potentially observable by LISA. 
